document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('pattern') && value !== '') {
                ...
                if (!pattern.test(value)) {
                    showError(input, input.getAttribute('data-pattern-error') || 'Invalid format');
                    return false;
                }
            }
            ...
            if (isValid) {
                ...
                fetch(formAction, fetchOptions)
                    ...
                    .then(function(data) {
                        ...
                        successMessage.textContent = data.message || 'Thank you! Your message has been sent successfully.';
                    ...
                    .catch(function(error) {
                        const errorMessage = contactForm.querySelector('.form-global-error') || document.createElement('div');
    ...
    if (animatedElements.length > 0) {
        ...
        document.addEventListener('scroll', function() {
            const elements = document.querySelectorAll('.fade-in.visible, .fade-in-up.visible, .fade-in-left.visible, .fade-in-right.visible, .animate-on-scroll.visible');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6362c43e-a0db-4698-99b1-687b27051d38',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6362c43e-a0db-4698-99b1-687b27051d38';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6362c43e-a0db-4698-99b1-687b27051d38';
